  ...
  return (
    <main className="h-screen text-black m-4 rounded-2xl p-4 flex flex-col">
      ...
      >
        ...
        <button
          type="Submit"
          className="px-4 py-2 bg-red-300 text-white rounded-2xl ml-1 hover:bg-red-400"
        >
          Enviar
        </button>
      </form>
      <button
        onClick={() => reset()}
        className="mt-2 px-4 py-2 bg-red-300 text-white rounded-2xl ml-1 hover:bg-red-400"
      >
        Resetear
      </button>
    </main>
