    ...
    <main className="max-w-3xl mx-auto p-6 gap-10">
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-center">
          Imagenes locales importadas
        </h2>
        <img
          src={imagenlocal}
          alt="Imagen Gorila"
          className="rounded-full h-20 w-20 hover:scale-120 transition-all duration-500 ease-in-out mx-auto"
        />
        <h2 className="text-xl font-semibold text-center">
          Imagenes externas importadas
        </h2>
        <img
          src="https://media.wired.com/photos/68b9b74debac84a11c241098/3:2/w_960,c_limit/Silksong_Promo_03.jpg"
          alt="Imagen Gorila"
          className="rounded-full h-20 w-20 hover:scale-120 transition-all duration-500 ease-in-out mx-auto"
        />
      </section>
      <section className="space-y-2">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://media.wired.com/photos/68b9b74debac84a11c241098/3:2/w_960,c_limit/Silksong_Promo_03.jpg')",
          }}
        >
